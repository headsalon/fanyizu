...
m_d: "乍一看，这似乎只是群选择理论的又一次复活，但Turchin的理论建立在全新的方法论基础之上，他将进化生物学的思想扩展运用于文化进化，为各种社会/文化指标给出了度量方法，并大量采用数量模型和统计工具，使得其理论在经验上变得可验证，由此，Turchin及其同道开创了一个自称为历史动力学的新学派。</br>
